...
#include "PropertyHelpers.generated.h"
...
UENUM(BlueprintType)
enum class EncodedStringStatus : uint8
{
...
UCLASS()
class UPropertyHelpers : public UObject
{
	GENERATED_BODY()

public:
	static SharedMode::StringHandle EncodeString(SharedMode::Object* Object, const FString& String, const SharedMode::StringHandle& ExistingHandle);
	static EncodedStringStatus GetEncodedStringStatus(SharedMode::StringMessage StringStatus);
};
